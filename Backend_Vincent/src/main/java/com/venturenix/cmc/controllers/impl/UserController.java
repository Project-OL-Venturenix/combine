...
import com.venturenix.cmc.controllers.UserOperation;
...
public class UserController implements UserOperation {
  ...
  public ResponseEntity<?> addUser(UserRequest userRequest) {
    User user = new User(userRequest.getFirstname(), userRequest.getLastname(),
        userRequest.getMobile(), userRequest.getEmail(),
        userRequest.getUsername(), encoder.encode(userRequest.getPassword()),
        userRequest.getCompany(), userRequest.getTitle(),
        userRequest.getPy_experience(), userRequest.getJv_experience(),
        userRequest.getJs_experience(), userRequest.getCs_experience(),
        userRequest.getSa_experience(), userRequest.getStatus(),
        java.time.LocalDateTime.now(), userRequest.getCreatedby(),
        java.time.LocalDateTime.now(), userRequest.getUpdatedby());
