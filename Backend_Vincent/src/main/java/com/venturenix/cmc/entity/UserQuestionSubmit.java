...
public class UserQuestionSubmit {
  ...
  public UserQuestionSubmit(Long eventid, Long userid, Long questionid, LocalDateTime submittime, Double runtimebymsec, String status, LocalDateTime createddate, Integer createdby, LocalDateTime updateddate, Integer updatedby) {
