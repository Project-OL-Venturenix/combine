...
public class Question2 {
  ...
  public static int executeTestCase(Question2 question, int[] nums1,
      int[] nums2, int[] nums3, double expectedAns) {
    List<Integer> actualAns = question.duplicateCounts(nums1,nums2,nums3);
    if (Math.abs(actualAns - expectedAns) < 0.00001) {
      System.out.println("Test Passed: Income=" + income + ", Expected Answer="
          + expectedAns + ", Actual Answer=" + actualAns);
      return 1;
    } else {
